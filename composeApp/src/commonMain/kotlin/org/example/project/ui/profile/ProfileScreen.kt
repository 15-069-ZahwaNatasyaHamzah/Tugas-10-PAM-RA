...
fun ProfileScreen(
    ...
    Column(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Spacer(modifier = Modifier.height(24.dp))
            Text("Device Info", style = MaterialTheme.typography.titleMedium, modifier = Modifier.padding(vertical = 8.dp))
            InfoItem(icon = Icons.Default.Info, text = "Device: ${viewModel.deviceInfo.deviceName}")
            InfoItem(icon = Icons.Default.Info, text = "OS: ${viewModel.deviceInfo.osName} (${viewModel.deviceInfo.osVersion})")
        }
    }
}
